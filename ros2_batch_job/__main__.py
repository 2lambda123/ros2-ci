...
def run(args, build_function, blacklisted_package_names=None):
    ...
    with change_directory(args.workspace):
        ...
        if sys.platform == "win32":
            ...
            if args.cmake_build_type == "Debug":
                pip_packages += [
                    ...
                    "https://github.com/ros2/ros2/releases/download/cryptography-archives/cffi-1.14.0-cp38-cp38d-win_amd64.whl",
        ...
        if ("rmw_fastrtps_cpp" in args.ignore_rmw
                and "rmw_connextdds" in args.ignore_rmw):
            blacklisted_package_names += [
        ...
        if ("rmw_fastrtps_cpp" in args.ignore_rmw
                and "rmw_fastrtps_dynamic_cpp" in args.ignore_rmw and
